...
class NeoDesk {
  ...
  /* ─── Engine icons ─── */
  _engineSvgs = {
    google: '<svg class="engine-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>',
    duckduckgo: '<svg class="engine-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="#DE5833"/><path d="M8 9.5c-.83 0-1.5-.67-1.5-1.5S7.17 6.5 8 6.5s1.5.67 1.5 1.5S8.83 9.5 8 9.5z" fill="#FFF"/><path d="M16 9.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" fill="#FFF"/><path d="M12 17c-2 0-3.5-.5-4.5-2h9c-1 1.5-2.5 2-4.5 2z" fill="#FFF"/></svg>',
    bing: '<svg class="engine-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M4 2v20l10-5 6 2V8L10 4l-6 6v4" stroke="#008373" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M14 17V8" stroke="#008373" stroke-width="2" stroke-linecap="round"/></svg>',
    brave: '<svg class="engine-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2L3 7l1.5 9L12 22l7.5-6L21 7l-9-5z" fill="#FB542B"/><path d="M9 10l3 4 3-4" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
    yahoo: '<svg class="engine-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 4l5 16h3l2-10 4 10h3L21 4" stroke="#6001D2" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
  };
